---
publish: true
title: "Maximum Total Value From Selecting K Subarrays"
description: "Select exactly k subarrays to maximize the sum of (max - min) values using a sparse table and a multiset."
